...
public class HistoryJobTabFragment extends BaseTabFragment {
    @Override
    public int[] getIcons() {
        return new int[0];
    }
    ...
    class MyAdapter extends FragmentPagerAdapter{
        ...
        {
            switch (position){
                case 0 : return new HistoryNewJobFragment();
                case 1 : return new HistoryInProgressJobFragment();
                case 2 : return new HistoryCompletedFragment();
            }
            return null;
        }
